...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-HVNNUUXG.js").then((m) => m.HomeComponent)
  },
  {
    path: "about",
    loadComponent: () => import("./chunk-SJF5UOSW.js").then((m) => m.AboutComponent)
  },
  {
    path: "professional",
    loadComponent: () => import("./chunk-WKQGWSYB.js").then((m) => m.ProfessionalLayoutComponent)
  },
  {
    path: "human",
    children: [
      ...
      {
        path: "journal",
        loadComponent: () => import("./chunk-TZVXFUEB.js").then((m) => m.MicroJournalComponent)
      },
      {
        path: "aviation",
        loadComponent: () => import("./chunk-7JCDSDZS.js").then((m) => m.AviationBridgeComponent)
      }
    ]
  },
  {
...
var NavbarComponent = class _NavbarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavbarComponent, selectors: [["app-navbar"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 25, vars: 12, consts: [[1, "navbar"], [1, "navbar-container"], ["routerLink", "/", 1, "navbar-logo", 3, "click"], [1, "logo-text"], ["aria-label", "Toggle menu", 1, "menu-toggle", 3, "click"], [1, "hamburger-line"], [1, "navbar-menu"], ["routerLink", "/", 3, "click"], ["routerLink", "/professional", 3, "click"], ["routerLink", "/human", 3, "click"], ["href", "https://rocketrealm.jaghan.com", "target", "_blank", "rel", "noopener"], ["routerLink", "/professional", "fragment", "contact", 3, "click"]], template: function NavbarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function NavbarComponent_Template_button_click_5_listener() {
        return ctx.toggleMenu();
      });
      \u0275\u0275element(6, "span", 5)(7, "span", 5)(8, "span", 5);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(18, "The Human Side");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(19, "li")(20, "a", 10);
      \u0275\u0275text(21, "RocketRealm \u2197");
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      \u0275\u0275classProp("menu-open", ctx.isMenuOpen)("hidden", !ctx.showNavbar);
      \u0275\u0275advance(6);
  ...
  }, dependencies: [CommonModule, RouterModule, RouterLink], styles: ['\n\n.navbar[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  z-index: 1000;\n  background: rgba(11, 13, 16, 0.95);\n  backdrop-filter: blur(10px);\n  border-bottom: 1px solid var(--border-subtle);\n  transition: all 0.3s ease;\n}\n.navbar.hidden[_ngcontent-%COMP%] {\n  opacity: 0;\n  pointer-events: none;\n  transform: translateY(-100%);\n}\n.navbar-container[_ngcontent-%COMP%] {\n  max-width: 1200px;\n  margin: 0 auto;\n  padding: var(--space-3) var(--space-5);\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.navbar-logo[_ngcontent-%COMP%] {\n  font-family: var(--font-heading);\n  font-size: 1.5rem;\n  font-weight: var(--fw-bold);\n  color: var(--accent-secondary);\n  text-decoration: none;\n  letter-spacing: var(--letter-wide);\n  transition: color 0.3s ease;\n}\n.navbar-logo[_ngcontent-%COMP%]:hover {\n  color: var(--accent-primary);\n}\n.navbar-menu[_ngcontent-%COMP%] {\n  display: flex;\n  list-style: none;\n  gap: var(--space-5);\n  margin: 0;\n  padding: 0;\n}\n.navbar-menu[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  color: var(--text-primary);\n  font-weight: var(--fw-medium);\n  font-size: var(--body);\n  position: relative;\n  transition: color 0.3s ease;\n}\n.navbar-menu[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  bottom: -5px;\n  left: 0;\n  width: 0;\n  height: 2px;\n  background: var(--accent-secondary);\n  transition: width 0.3s ease;\n}\n.navbar-menu[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n  color: var(--accent-secondary);\n}\n.navbar-menu[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover::after {\n  width: 100%;\n}\n.navbar-menu[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a.router-link-active[_ngcontent-%COMP%] {\n  color: var(--accent-secondary);\n}\n.navbar-menu[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a.router-link-active[_ngcontent-%COMP%]::after {\n  width: 100%;\n}\n.menu-toggle[_ngcontent-%COMP%] {\n  display: none;\n  flex-direction: column;\n  gap: 5px;\n  background: transparent;\n  border: none;\n  cursor: pointer;\n  padding: var(--space-2);\n}\n.menu-toggle[_ngcontent-%COMP%]   .hamburger-line[_ngcontent-%COMP%] {\n  width: 25px;\n  height: 2px;\n  background: var(--text-primary);\n  transition: all 0.3s ease;\n}\n.menu-toggle[_ngcontent-%COMP%]   .hamburger-line.active[_ngcontent-%COMP%]:nth-child(1) {\n  transform: rotate(45deg) translate(8px, 8px);\n}\n.menu-toggle[_ngcontent-%COMP%]   .hamburger-line.active[_ngcontent-%COMP%]:nth-child(2) {\n  opacity: 0;\n}\n.menu-toggle[_ngcontent-%COMP%]   .hamburger-line.active[_ngcontent-%COMP%]:nth-child(3) {\n  transform: rotate(-45deg) translate(7px, -7px);\n}\n@media (max-width: 768px) {\n  .menu-toggle[_ngcontent-%COMP%] {\n    display: flex;\n  }\n  .navbar-menu[_ngcontent-%COMP%] {\n    position: fixed;\n    top: 70px;\n    left: 0;\n    right: 0;\n    flex-direction: column;\n    background: rgba(11, 13, 16, 0.98);\n    padding: var(--space-5);\n    gap: var(--space-4);\n    transform: translateX(-100%);\n    transition: transform 0.3s ease;\n    border-top: 1px solid var(--border-subtle);\n  }\n  .navbar-menu.active[_ngcontent-%COMP%] {\n    transform: translateX(0);\n  }\n  .navbar-menu[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n    font-size: var(--body-lg);\n  }\n}\n/*# sourceMappingURL=navbar.component.css.map */'] });
};
(() => {
