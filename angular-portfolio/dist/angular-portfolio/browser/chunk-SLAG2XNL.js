...
var ScrollService = class _ScrollService {
  scrollPositionSubject = new BehaviorSubject(0);
  scrollPosition$ = this.scrollPositionSubject.asObservable();
  scrollDirectionSubject = new BehaviorSubject("down");
  ...
  initScrollListener() {
    fromEvent(window, "wheel", { passive: false }).pipe(throttleTime(500)).subscribe((event) => {
      if (this.isScrolling) {
        event.preventDefault();
        return;
      }
    ...
    fromEvent(window, "scroll", { passive: true }).pipe(debounceTime(50)).subscribe(() => {
  ...
  isInViewport(element, threshold = 0) {
    ...
    return rect.top >= -threshold && rect.left >= 0 && rect.bottom <= (window.innerHeight || document.documentElement.clientHeight) + threshold && rect.right <= (window.innerWidth || document.documentElement.clientWidth);
  }
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-SLAG2XNL.js.map
