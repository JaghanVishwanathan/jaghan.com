    ...
    return of([
      {
        ...
        university: "Technische Universit\xE4t Darmstadt",
        location: "Darmstadt, Germany"
      },
      {
...
// src/app/components/professional/experience/experience.component.ts
function ExperienceComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5);
    \u0275\u0275element(1, "div", 6);
    \u0275\u0275elementStart(2, "div", 7)(3, "div", 8)(4, "div", 9)(5, "div", 10);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "h3", 11);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("volunteer", exp_r1.isVolunteer);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(exp_r1.period);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(exp_r1.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(exp_r1.company);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(exp_r1.location);
    \u0275\u0275advance(2);
    \u0275\u0275property("src", "assets/images/logos/" + ctx_r1.getCompanyLogo(exp_r1.company), \u0275\u0275sanitizeUrl)("alt", exp_r1.company + " logo");
  }
}
var ExperienceComponent = class _ExperienceComponent {
  ...
  static \u0275fac = function ExperienceComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ExperienceComponent)(\u0275\u0275directiveInject(ContentService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExperienceComponent, selectors: [["app-experience"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 1, consts: [[1, "experience", "section"], [1, "container"], [1, "section-title"], [1, "timeline"], ["class", "timeline-item", 3, "volunteer", 4, "ngFor", "ngForOf"], [1, "timeline-item"], [1, "timeline-marker"], [1, "timeline-content"], [1, "timeline-header"], [1, "timeline-info"], [1, "timeline-period"], [1, "timeline-title"], [1, "timeline-company"], [1, "timeline-location"], [1, "timeline-logo"], ["onerror", "this.style.display='none';", 3, "src", "alt"]], template: function ExperienceComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "h2", 2);
      \u0275\u0275text(3, "Experience");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 3);
      \u0275\u0275template(5, ExperienceComponent_div_5_Template, 15, 8, "div", 4);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
function EducationComponent_div_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(edu_r1.field);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(edu_r1.university);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(edu_r1.location);
  }
}
var EducationComponent = class _EducationComponent {
  ...
  static \u0275fac = function EducationComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EducationComponent)(\u0275\u0275directiveInject(ContentService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EducationComponent, selectors: [["app-education"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 1, consts: [[1, "education", "section"], [1, "container"], [1, "section-title"], [1, "education-timeline"], ["class", "education-item", 4, "ngFor", "ngForOf"], [1, "education-item"], [1, "education-marker"], [1, "education-content"], [1, "education-period"], [1, "education-degree"], [1, "education-field"], [1, "education-university"], [1, "education-location"]], template: function EducationComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "h2", 2);
      \u0275\u0275text(3, "Education");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 3);
      \u0275\u0275template(5, EducationComponent_div_5_Template, 13, 5, "div", 4);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
      \u0275\u0275property("ngForOf", ctx.education);
    }
  }, dependencies: [CommonModule, NgForOf], styles: ['\n\n.education[_ngcontent-%COMP%] {\n  padding: var(--space-7) 0;\n  background: var(--bg-primary);\n}\n.section-title[_ngcontent-%COMP%] {\n  text-align: center;\n  margin-bottom: var(--space-7);\n  font-size: var(--h2);\n  color: var(--accent-secondary);\n  font-weight: var(--fw-semibold);\n}\n.education-timeline[_ngcontent-%COMP%] {\n  position: relative;\n  max-width: 1200px;\n  margin: 0 auto;\n  padding-left: var(--space-5);\n}\n.education-timeline[_ngcontent-%COMP%]::before {\n  content: "";\n  position: absolute;\n  left: 0;\n  top: 0;\n  bottom: 0;\n  width: 2px;\n  background:\n    linear-gradient(\n      180deg,\n      var(--accent-secondary) 0%,\n      var(--accent-primary) 100%);\n}\n.education-item[_ngcontent-%COMP%] {\n  position: relative;\n  margin-bottom: var(--space-5);\n  padding-left: var(--space-6);\n  animation: slideIn 0.6s ease-out;\n}\n.education-marker[_ngcontent-%COMP%] {\n  position: absolute;\n  left: -1.5rem;\n  top: 0.5rem;\n  width: 16px;\n  height: 16px;\n  border-radius: 50%;\n  background: var(--accent-secondary);\n  border: 3px solid var(--bg-primary);\n  box-shadow: 0 0 10px rgba(56, 189, 248, 0.5);\n}\n.education-content[_ngcontent-%COMP%] {\n  padding: 0;\n}\n.education-period[_ngcontent-%COMP%] {\n  color: var(--accent-secondary);\n  font-weight: var(--fw-semibold);\n  font-size: var(--body-sm);\n  text-transform: uppercase;\n  letter-spacing: var(--letter-wide);\n  margin-bottom: var(--space-3);\n}\n.education-degree[_ngcontent-%COMP%] {\n  font-size: var(--h3);\n  margin-bottom: var(--space-2);\n  color: var(--text-primary);\n  font-weight: var(--fw-semibold);\n}\n.education-field[_ngcontent-%COMP%] {\n  color: var(--text-secondary);\n  font-size: var(--body-lg);\n  margin-bottom: var(--space-2);\n}\n.education-university[_ngcontent-%COMP%] {\n  color: var(--text-primary);\n  font-size: var(--body-lg);\n  font-weight: var(--fw-medium);\n  margin-bottom: var(--space-1);\n}\n.education-location[_ngcontent-%COMP%] {\n  color: var(--text-secondary);\n  font-size: var(--body-sm);\n}\n@media (max-width: 768px) {\n  .education-item[_ngcontent-%COMP%] {\n    padding: var(--space-4);\n  }\n}\n/*# sourceMappingURL=education.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EducationComponent, { className: "EducationComponent", filePath: "src\\app\\components\\professional\\education\\education.component.ts", lineNumber: 12 });
})();

// src/app/components/professional/skills/skills.component.ts
function SkillsComponent_div_5_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "div", 10);
    \u0275\u0275element(2, "img", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 12)(4, "h4", 13);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("src", "assets/images/logos/" + skill_r1.icon, \u0275\u0275sanitizeUrl)("alt", skill_r1.name + " logo");
    \u0275\u0275advance(3);
...
function SkillsComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, SkillsComponent_div_5_div_4_Template, 8, 4, "div", 8);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const category_r2 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", category_r2.category, ".");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", category_r2.skills);
  }
}
var SkillsComponent = class _SkillsComponent {
  ...
  static \u0275fac = function SkillsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SkillsComponent)(\u0275\u0275directiveInject(ContentService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SkillsComponent, selectors: [["app-skills"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 1, consts: [[1, "skills", "section"], [1, "container"], [1, "section-title"], [1, "skills-categories"], ["class", "skill-category-group", 4, "ngFor", "ngForOf"], [1, "skill-category-group"], [1, "category-title"], [1, "skills-grid"], ["class", "skill-item", 4, "ngFor", "ngForOf"], [1, "skill-item"], [1, "skill-icon"], ["onerror", "this.style.display='none';", 3, "src", "alt"], [1, "skill-info"], [1, "skill-name"], [1, "skill-description"]], template: function SkillsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "h2", 2);
      \u0275\u0275text(3, "Skills");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 3);
      \u0275\u0275template(5, SkillsComponent_div_5_Template, 5, 2, "div", 4);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
function ProjectsComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ProjectsComponent_div_5_Template_div_click_0_listener() {
      ...
      return \u0275\u0275resetView(ctx_r2.openProject(project_r2));
    });
    ...
    \u0275\u0275template(6, ProjectsComponent_div_5_span_6_Template, 2, 1, "span", 10);
    \u0275\u0275elementEnd();
...
function ProjectsComponent_div_6_span_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 12);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(tech_r6);
  }
}
function ProjectsComponent_div_6_div_13_li_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProjectsComponent_div_6_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20)(1, "h4");
    \u0275\u0275text(2, "Achievements:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ul");
    \u0275\u0275template(4, ProjectsComponent_div_6_div_13_li_4_Template, 2, 1, "li", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngForOf", ctx_r2.selectedProject.achievements);
  }
}
function ProjectsComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ProjectsComponent_div_6_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeProject());
    });
    \u0275\u0275elementStart(1, "div", 14);
    \u0275\u0275listener("click", function ProjectsComponent_div_6_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "button", 15);
    \u0275\u0275listener("click", function ProjectsComponent_div_6_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeProject());
    });
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 17)(9, "h4");
    \u0275\u0275text(10, "Technologies:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 18);
    \u0275\u0275template(12, ProjectsComponent_div_6_span_12_Template, 2, 1, "span", 10);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, ProjectsComponent_div_6_div_13_Template, 5, 1, "div", 19);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r2.selectedProject.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.selectedProject.description);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngForOf", ctx_r2.selectedProject.technologies);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.selectedProject.achievements);
  }
}
var ProjectsComponent = class _ProjectsComponent {
  ...
  static \u0275fac = function ProjectsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ProjectsComponent)(\u0275\u0275directiveInject(ContentService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProjectsComponent, selectors: [["app-projects"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 7, vars: 2, consts: [[1, "projects", "section"], [1, "container"], [1, "section-title"], [1, "projects-grid"], ["class", "project-card", 3, "click", 4, "ngFor", "ngForOf"], ["class", "project-modal", 3, "click", 4, "ngIf"], [1, "project-card", 3, "click"], [1, "project-name"], [1, "project-description"], [1, "project-tech"], ["class", "tech-tag", 4, "ngFor", "ngForOf"], [1, "project-link"], [1, "tech-tag"], [1, "project-modal", 3, "click"], [1, "modal-content", 3, "click"], [1, "close-btn", 3, "click"], [1, "modal-description"], [1, "modal-tech"], [1, "tech-list"], ["class", "modal-achievements", 4, "ngIf"], [1, "modal-achievements"], [4, "ngFor", "ngForOf"]], template: function ProjectsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "h2", 2);
      \u0275\u0275text(3, "Projects");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 3);
      \u0275\u0275template(5, ProjectsComponent_div_5_Template, 9, 3, "div", 4);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(6, ProjectsComponent_div_6_Template, 14, 4, "div", 5);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf], styles: ['\n\n.projects[_ngcontent-%COMP%] {\n  padding: var(--space-7) 0;\n  background: var(--bg-primary);\n}\n.section-title[_ngcontent-%COMP%] {\n  text-align: center;\n  margin-bottom: var(--space-7);\n  font-size: var(--h2);\n  color: var(--accent-secondary);\n  font-weight: var(--fw-semibold);\n}\n.projects-grid[_ngcontent-%COMP%] {\n  max-width: 1200px;\n  margin: 0 auto;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(350px, 1fr));\n  gap: var(--space-6);\n}\n.project-card[_ngcontent-%COMP%] {\n  background: var(--bg-elevated);\n  padding: var(--space-6);\n  border-radius: 12px;\n  border: 2px solid var(--border-subtle);\n  cursor: pointer;\n  transition: all 0.3s ease;\n  animation: fadeIn 0.6s ease-out;\n  position: relative;\n  overflow: hidden;\n}\n.project-card[_ngcontent-%COMP%]::before {\n  content: "";\n  position: absolute;\n  top: 0;\n  left: -100%;\n  width: 100%;\n  height: 100%;\n  background:\n    linear-gradient(\n      90deg,\n      transparent,\n      rgba(56, 189, 248, 0.1),\n      transparent);\n  transition: left 0.5s ease;\n}\n.project-card[_ngcontent-%COMP%]:hover {\n  border-color: var(--accent-secondary);\n  transform: translateY(-10px);\n  box-shadow: 0 10px 40px rgba(56, 189, 248, 0.2);\n}\n.project-card[_ngcontent-%COMP%]:hover::before {\n  left: 100%;\n}\n.project-name[_ngcontent-%COMP%] {\n  font-size: var(--h3);\n  color: var(--accent-secondary);\n  margin-bottom: var(--space-3);\n  font-weight: var(--fw-semibold);\n}\n.project-description[_ngcontent-%COMP%] {\n  color: var(--text-primary);\n  line-height: 1.8;\n  margin-bottom: var(--space-4);\n  font-size: var(--body);\n}\n.project-tech[_ngcontent-%COMP%] {\n  display: flex;\n  flex-wrap: wrap;\n  gap: var(--space-2);\n  margin-bottom: var(--space-3);\n}\n.tech-tag[_ngcontent-%COMP%] {\n  display: inline-block;\n  padding: var(--space-1) var(--space-3);\n  background: rgba(56, 189, 248, 0.1);\n  border: 1px solid rgba(56, 189, 248, 0.3);\n  border-radius: 15px;\n  color: var(--text-primary);\n  font-size: var(--body-sm);\n}\n.project-link[_ngcontent-%COMP%] {\n  color: var(--accent-secondary);\n  font-weight: var(--fw-semibold);\n  margin-top: var(--space-3);\n  transition: transform 0.3s ease;\n}\n.project-card[_ngcontent-%COMP%]:hover   .project-link[_ngcontent-%COMP%] {\n  transform: translateX(5px);\n}\n.project-modal[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: rgba(0, 0, 0, 0.9);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 2000;\n  padding: var(--space-5);\n  animation: fadeIn 0.3s ease;\n}\n.modal-content[_ngcontent-%COMP%] {\n  background: var(--bg-elevated);\n  border: 2px solid var(--accent-secondary);\n  border-radius: 12px;\n  padding: var(--space-7);\n  max-width: 700px;\n  max-height: 90vh;\n  overflow-y: auto;\n  position: relative;\n  animation: slideIn 0.3s ease;\n}\n.modal-content[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  color: var(--accent-secondary);\n  margin-bottom: var(--space-4);\n  font-size: var(--h2);\n}\n.modal-content[_ngcontent-%COMP%]   .modal-description[_ngcontent-%COMP%] {\n  color: var(--text-primary);\n  line-height: 1.8;\n  margin-bottom: var(--space-5);\n  font-size: var(--body-lg);\n}\n.modal-content[_ngcontent-%COMP%]   .modal-tech[_ngcontent-%COMP%], \n.modal-content[_ngcontent-%COMP%]   .modal-achievements[_ngcontent-%COMP%] {\n  margin-bottom: var(--space-5);\n}\n.modal-content[_ngcontent-%COMP%]   .modal-tech[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%], \n.modal-content[_ngcontent-%COMP%]   .modal-achievements[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%] {\n  color: var(--accent-secondary);\n  margin-bottom: var(--space-3);\n  font-weight: var(--fw-semibold);\n}\n.modal-content[_ngcontent-%COMP%]   .modal-tech[_ngcontent-%COMP%]   ul[_ngcontent-%COMP%], \n.modal-content[_ngcontent-%COMP%]   .modal-achievements[_ngcontent-%COMP%]   ul[_ngcontent-%COMP%] {\n  list-style: none;\n  padding: 0;\n}\n.modal-content[_ngcontent-%COMP%]   .modal-tech[_ngcontent-%COMP%]   ul[_ngcontent-%COMP%]   li[_ngcontent-%COMP%], \n.modal-content[_ngcontent-%COMP%]   .modal-achievements[_ngcontent-%COMP%]   ul[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  color: var(--text-primary);\n  padding-left: var(--space-4);\n  position: relative;\n  margin-bottom: var(--space-2);\n  font-size: var(--body);\n}\n.modal-content[_ngcontent-%COMP%]   .modal-tech[_ngcontent-%COMP%]   ul[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]::before, \n.modal-content[_ngcontent-%COMP%]   .modal-achievements[_ngcontent-%COMP%]   ul[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]::before {\n  content: "\\2713";\n  position: absolute;\n  left: 0;\n  color: var(--accent-secondary);\n}\n.close-btn[_ngcontent-%COMP%] {\n  position: absolute;\n  top: var(--space-3);\n  right: var(--space-3);\n  background: transparent;\n  border: none;\n  color: var(--text-primary);\n  font-size: 2rem;\n  cursor: pointer;\n  width: 40px;\n  height: 40px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 50%;\n  transition: all 0.3s ease;\n}\n.close-btn[_ngcontent-%COMP%]:hover {\n  background: var(--bg-elevated);\n  color: var(--accent-secondary);\n}\n@media (max-width: 768px) {\n  .projects-grid[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr;\n  }\n  .modal-content[_ngcontent-%COMP%] {\n    padding: var(--space-5);\n  }\n}\n/*# sourceMappingURL=projects.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProjectsComponent, { className: "ProjectsComponent", filePath: "src\\app\\components\\professional\\projects\\projects.component.ts", lineNumber: 12 });
})();

// src/app/components/professional/languages/languages.component.ts
function LanguagesComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "div", 6);
    \u0275\u0275element(2, "img", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 8)(4, "div", 9)(5, "h3", 10);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 11);
    \u0275\u0275text(8);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("src", "assets/images/flags/" + lang_r1.flagImage, \u0275\u0275sanitizeUrl)("alt", lang_r1.name + " flag");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(lang_r1.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(lang_r1.proficiency);
  }
}
var LanguagesComponent = class _LanguagesComponent {
  ...
  static \u0275fac = function LanguagesComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LanguagesComponent)(\u0275\u0275directiveInject(ContentService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LanguagesComponent, selectors: [["app-languages"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 1, consts: [[1, "languages", "section"], [1, "container"], [1, "section-title"], [1, "languages-grid"], ["class", "language-card", 4, "ngFor", "ngForOf"], [1, "language-card"], [1, "language-flag-background"], ["onerror", "this.style.display='none';", 1, "flag-image", 3, "src", "alt"], [1, "language-content-overlay"], [1, "language-info"], [1, "language-name"], [1, "language-proficiency"]], template: function LanguagesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "h2", 2);
      \u0275\u0275text(3, "Languages");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 3);
      \u0275\u0275template(5, LanguagesComponent_div_5_Template, 9, 4, "div", 4);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
  ...
  }, dependencies: [CommonModule, NgForOf], styles: ['\n\n.languages[_ngcontent-%COMP%] {\n  padding: var(--space-7) 0;\n  background: var(--bg-primary);\n  position: relative;\n}\n.section-title[_ngcontent-%COMP%] {\n  text-align: center;\n  margin-bottom: var(--space-7);\n  font-size: var(--h2);\n  color: var(--accent-secondary);\n  font-weight: var(--fw-semibold);\n}\n.languages-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(350px, 1fr));\n  gap: var(--space-6);\n  max-width: 1400px;\n  margin: 0 auto;\n  padding: 0 var(--space-5);\n}\n.language-card[_ngcontent-%COMP%] {\n  position: relative;\n  min-height: 280px;\n  border-radius: 20px;\n  overflow: hidden;\n  border: 2px solid var(--border-subtle);\n  transition: all 0.4s ease;\n  animation: fadeIn 0.6s ease-out;\n  cursor: pointer;\n  background: var(--bg-elevated);\n}\n.language-card[_ngcontent-%COMP%]:hover {\n  border-color: var(--accent-secondary);\n  transform: translateY(-8px);\n  box-shadow: 0 15px 40px rgba(56, 189, 248, 0.25);\n}\n.language-flag-background[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  overflow: hidden;\n  opacity: 0.5;\n}\n.language-flag-background[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: var(--bg-elevated);\n  opacity: 0.6;\n  z-index: 1;\n}\n.flag-image[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  filter: blur(8px) brightness(0.8);\n  transform: scale(1.1);\n  transition: all 0.4s ease;\n}\n.language-card[_ngcontent-%COMP%]:hover   .flag-image[_ngcontent-%COMP%] {\n  filter: blur(6px) brightness(1.3);\n  transform: scale(1.05);\n}\n.language-content-overlay[_ngcontent-%COMP%] {\n  position: relative;\n  z-index: 2;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: var(--space-6);\n  background:\n    linear-gradient(\n      135deg,\n      rgba(11, 13, 16, 0.85) 0%,\n      rgba(11, 13, 16, 0.7) 100%);\n  backdrop-filter: blur(2px);\n}\n.language-info[_ngcontent-%COMP%] {\n  text-align: center;\n  width: 100%;\n}\n.language-name[_ngcontent-%COMP%] {\n  font-size: var(--h2);\n  color: var(--text-primary);\n  margin-bottom: var(--space-3);\n  font-weight: var(--fw-bold);\n  text-shadow: 0 2px 10px rgba(0, 0, 0, 0.5);\n  letter-spacing: var(--letter-wide);\n}\n.language-proficiency[_ngcontent-%COMP%] {\n  display: inline-block;\n  font-size: var(--body-lg);\n  color: var(--accent-secondary);\n  font-weight: var(--fw-bold);\n  padding: var(--space-2) var(--space-5);\n  background: rgba(56, 189, 248, 0.15);\n  border: 2px solid var(--accent-secondary);\n  border-radius: 30px;\n  text-transform: uppercase;\n  letter-spacing: 0.1em;\n  backdrop-filter: blur(10px);\n  box-shadow: 0 4px 15px rgba(56, 189, 248, 0.2);\n}\n.language-card[_ngcontent-%COMP%]:hover   .language-proficiency[_ngcontent-%COMP%] {\n  background: rgba(56, 189, 248, 0.25);\n  box-shadow: 0 6px 20px rgba(56, 189, 248, 0.3);\n  transform: scale(1.05);\n  transition: all 0.3s ease;\n}\n@media (max-width: 768px) {\n  .languages-grid[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr;\n    gap: var(--space-4);\n    padding: 0 var(--space-3);\n  }\n  .language-card[_ngcontent-%COMP%] {\n    min-height: 240px;\n  }\n  .language-name[_ngcontent-%COMP%] {\n    font-size: var(--h3);\n  }\n  .language-content-overlay[_ngcontent-%COMP%] {\n    padding: var(--space-5);\n  }\n}\n/*# sourceMappingURL=languages.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LanguagesComponent, { className: "LanguagesComponent", filePath: "src\\app\\components\\professional\\languages\\languages.component.ts", lineNumber: 12 });
})();
...
// src/app/components/professional/contact/contact.component.ts
function ContactComponent_p_31_Template(rf, ctx) {
  if (rf & 1) {
...
var ContactComponent = class _ContactComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactComponent, selectors: [["app-contact"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 32, vars: 4, consts: [["id", "contact", 1, "contact", "section"], [1, "container"], [1, "section-title"], [1, "contact-content"], [1, "contact-info"], [1, "contact-intro"], [1, "contact-details"], ["href", "mailto:jaghan2001@gmail.com", 1, "contact-item"], [1, "contact-icon"], ["src", "assets/images/icons/mail.png", "alt", "Mail", 1, "contact-icon-image"], ["href", "https://www.linkedin.com/in/jaghanvishwanathan", "target", "_blank", "rel", "noopener", 1, "contact-item"], ["src", "assets/images/icons/linkedin.png", "alt", "LinkedIn", 1, "contact-icon-image"], ["href", "assets/jaghanvishwanathana.pdf", "download", "", 1, "contact-item"], ["src", "assets/images/icons/resume.png", "alt", "Download Resume", 1, "contact-icon-image"], [1, "contact-form-container"], [1, "contact-form", 3, "ngSubmit"], ["type", "text", "name", "Name", "placeholder", "Your Name", "required", "", 1, "form-input", 3, "ngModelChange", "ngModel"], ["type", "email", "name", "Email", "placeholder", "Your Email", "required", "", 1, "form-input", 3, "ngModelChange", "ngModel"], ["name", "Message", "rows", "6", "placeholder", "Your Message", "required", "", 1, "form-textarea", 3, "ngModelChange", "ngModel"], ["type", "submit", 1, "submit-button"], ["class", "submit-message", 4, "ngIf"], [1, "submit-message"]], template: function ContactComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "section", 0)(1, "div", 1)(2, "h2", 2);
      \u0275\u0275text(3, "Contact");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 3)(5, "div", 4)(6, "p", 5);
      \u0275\u0275text(7, "Want to build something meaningful together?");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "div", 6)(9, "a", 7)(10, "span", 8);
      \u0275\u0275element(11, "img", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "span");
      \u0275\u0275text(13, "jaghan2001@gmail.com");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(18, "LinkedIn");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(19, "a", 12)(20, "span", 8);
      \u0275\u0275element(21, "img", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "span");
      \u0275\u0275text(23, "Download Resume");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(24, "div", 14)(25, "form", 15);
      \u0275\u0275listener("ngSubmit", function ContactComponent_Template_form_ngSubmit_25_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275elementStart(26, "input", 16);
      \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Template_input_ngModelChange_26_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.contactForm.name, $event) || (ctx.contactForm.name = $event);
        return $event;
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "input", 17);
      \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Template_input_ngModelChange_27_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.contactForm.email, $event) || (ctx.contactForm.email = $event);
        return $event;
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(28, "textarea", 18);
      \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Template_textarea_ngModelChange_28_listener($event) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(31, ContactComponent_p_31_Template, 2, 1, "p", 20);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(26);
...
var FooterComponent = class _FooterComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 9, vars: 0, consts: [[1, "footer"], [1, "footer-content"], [1, "legacy-button", 3, "click"], [1, "legacy-icon"], [1, "legacy-text"], [1, "footer-note"]], template: function FooterComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "footer", 0)(1, "div", 1)(2, "button", 2);
      \u0275\u0275listener("click", function FooterComponent_Template_button_click_2_listener() {
        return ctx.openLegacyWebsite();
      });
      \u0275\u0275elementStart(3, "span", 3);
      \u0275\u0275text(4, "\u23EE");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "span", 4);
      \u0275\u0275text(6, "Legacy Website");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "p", 5);
      \u0275\u0275text(8, "Visit my previous portfolio design");
      \u0275\u0275elementEnd()()();
    }
  }, dependencies: [CommonModule], styles: ["\n\n.footer[_ngcontent-%COMP%] {\n  padding: var(--space-7) 0 var(--space-6) 0;\n  background: transparent;\n  position: relative;\n}\n.footer-content[_ngcontent-%COMP%] {\n  max-width: 1400px;\n  margin: 0 auto;\n  padding: 0 var(--space-5);\n  text-align: center;\n}\n.legacy-button[_ngcontent-%COMP%] {\n  background: transparent;\n  border: 2px solid var(--border-subtle);\n  border-radius: 8px;\n  padding: var(--space-3) var(--space-6);\n  color: var(--text-secondary);\n  font-size: var(--body);\n  font-weight: var(--fw-medium);\n  cursor: pointer;\n  transition: all 0.3s ease;\n  display: inline-flex;\n  align-items: center;\n  gap: var(--space-2);\n  font-family: inherit;\n  margin-bottom: var(--space-2);\n}\n.legacy-button[_ngcontent-%COMP%]:hover {\n  border-color: var(--accent-secondary);\n  color: var(--accent-secondary);\n  background: rgba(56, 189, 248, 0.05);\n  transform: translateY(-2px);\n  box-shadow: 0 4px 12px rgba(56, 189, 248, 0.15);\n}\n.legacy-icon[_ngcontent-%COMP%] {\n  font-size: var(--body-lg);\n  opacity: 0.8;\n}\n.legacy-text[_ngcontent-%COMP%] {\n  letter-spacing: 0.05em;\n}\n.footer-note[_ngcontent-%COMP%] {\n  font-size: var(--body-sm);\n  color: var(--text-disabled);\n  margin-top: var(--space-2);\n  font-style: italic;\n}\n@media (max-width: 768px) {\n  .footer[_ngcontent-%COMP%] {\n    padding: var(--space-5) 0 var(--space-4) 0;\n  }\n  .legacy-button[_ngcontent-%COMP%] {\n    padding: var(--space-2) var(--space-4);\n    font-size: var(--body-sm);\n  }\n}\n/*# sourceMappingURL=footer.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterComponent, { className: "FooterComponent", filePath: "src\\app\\components\\professional\\footer\\footer.component.ts", lineNumber: 11 });
})();

// src/app/components/professional/professional-layout/professional-layout.component.ts
var ProfessionalLayoutComponent = class _ProfessionalLayoutComponent {
  scrollService;
  route;
  router;
  subscriptions = new Subscription();
  constructor(scrollService, route, router) {
  ...
  static \u0275fac = function ProfessionalLayoutComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ProfessionalLayoutComponent)(\u0275\u0275directiveInject(ScrollService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProfessionalLayoutComponent, selectors: [["app-professional-layout"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 0, consts: [[1, "professional-layout"]], template: function ProfessionalLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275element(1, "app-experience")(2, "app-education")(3, "app-skills")(4, "app-projects")(5, "app-languages")(6, "app-contact")(7, "app-footer");
      \u0275\u0275elementEnd();
    }
  }, dependencies: [
    CommonModule,
    ...
    ContactComponent,
    FooterComponent
  ], styles: ["\n\n.professional-layout[_ngcontent-%COMP%] {\n  display: block;\n}\n/*# sourceMappingURL=professional-layout.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProfessionalLayoutComponent, { className: "ProfessionalLayoutComponent", filePath: "src\\app\\components\\professional\\professional-layout\\professional-layout.component.ts", lineNumber: 32 });
})();
export {
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-WKQGWSYB.js.map
